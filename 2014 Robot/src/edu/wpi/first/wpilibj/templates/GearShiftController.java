...
public class GearShiftController implements IStep{
    ...
    private NewSolenoid leftSolenoid, rightSolenoid;
    ...
    public void step(){
        ...
        leftSolenoid.set(isFast);
        rightSolenoid.set(!isFast);
    }
    ...
    public GearShiftController setLeftSolenoid(NewSolenoid solenoid){
        this.leftSolenoid=solenoid;
        return this;
    }
    public GearShiftController setRightSolenoid(NewSolenoid solenoid){
        this.rightSolenoid=solenoid;
        return this;
    }
